"""
This module contains custom training callbacks for TensorFlow/Keras models to be used
during training.
"""
...
class LRLogger(tf.keras.callbacks.Callback):
    ...
    def on_train_begin(self, logs=None) -> None:
        ...
        self.lrs_begin.clear()
        self.lrs_end.clear()
        self.reductions_cum.clear()
        self.epochs.clear()
        self._reductions = 0
        self._lr_begin = None
    ...
    def _resolve_lr(self) -> float:
        ...
        lr = (
            opt.learning_rate
        )  # This should always exist, if not it will raise an AttributeError
    ...
    def on_epoch_end(self, epoch, logs=None) -> None:
        ...
        self.lrs_begin.append(
            float(self._lr_begin if self._lr_begin is not None else lr_end)
        )
